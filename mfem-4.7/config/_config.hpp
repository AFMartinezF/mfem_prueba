...
#define MFEM_VERSION 40700

// MFEM version string of the form "3.3" or "3.3.1".
#define MFEM_VERSION_STRING "4.7"
...
#define MFEM_SOURCE_DIR "/workspaces/mfem_prueba/mfem-4.7"

// The absolute path of the MFEM installation prefix.
#define MFEM_INSTALL_DIR "/workspaces/mfem_prueba/mfem-4.7/mfem"
